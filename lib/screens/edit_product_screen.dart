...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  Product product = Product(id: null, title: '', description: '', price: null, imageUrl: '');
  var _isInit = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('${product.id == null ? 'Create Product' : 'Edit Product'}'),
        actions: <Widget>[
          IconButton(
          ...
          child: ListView(
            children: <Widget>[
              ...
              TextFormField(
                ...
                validator: (val) {
                  if (val.isEmpty) return 'This field is required';
                  if (val.length < 10) return 'You can write more than 10 chars, right?';
                  return null;
                },
                onSaved: (val) {
                  product = Product(
